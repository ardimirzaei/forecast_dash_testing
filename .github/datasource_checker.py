...
print(f"There are { results_grouped['Status'][(results_grouped['index'] >= 200) & (results_grouped['index'] <= 400)].sum()} data sources that are reachable.")
print(f"The following {results_grouped['Status'][results_grouped['index'] > 400].sum()} are not reachable:\n")
